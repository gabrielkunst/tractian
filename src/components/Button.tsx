...
const buttonVariants = {
  variant: {
    default:
      'border border-transparent bg-primary text-white hover:bg-primary/90 focus-visible:ring-primary/50',
    outline:
      'border border-custom-gray-200 text-custom-gray-600 bg-transparent focus-visible:ring-custom-gray-200',
    secondary:
      'border border-transparent bg-secondary text-custom-white hover:bg-secondary/50',
